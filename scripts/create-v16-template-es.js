...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v16-template-es.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v16-es');
formData.append('comment', 'Spanish - Professional focused (Mar 2026)');
