...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v16-template.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v16');
formData.append('comment', 'English - Professional focused (Mar 2026)');
