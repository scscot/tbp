#!/usr/bin/env node
/**
 * Create v17 Mailgun template (English)
 * v17 uses generic "Greetings!" greeting (no personalization)
...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v17-template.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v17');
formData.append('comment', 'English - Generic greeting (Mar 2026)');
