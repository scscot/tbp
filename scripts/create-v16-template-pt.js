...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v16-template-pt.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v16-pt');
formData.append('comment', 'Portuguese - Professional focused (Mar 2026)');
