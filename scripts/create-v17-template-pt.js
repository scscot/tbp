#!/usr/bin/env node
/**
 * Create v17-pt Mailgun template (Portuguese)
 * v17 uses generic "Saudacoes!" greeting (no personalization)
...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v17-template-pt.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v17-pt');
formData.append('comment', 'Portuguese - Generic greeting (Mar 2026)');
...
formData.append('headers', JSON.stringify({
  ...
  "Subject": "Seus prospectos nao acreditam que podem recrutar"
}));
