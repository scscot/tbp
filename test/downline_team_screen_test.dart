...
import 'package:ultimatefix/screens/team_screen.dart';

void main() {
  group('TeamScreen Tests', () {
    testWidgets('TeamScreen builds without errors', (WidgetTester tester) async {
      // Build the TeamScreen widget
      await tester.pumpWidget(
        MaterialApp(
          home: TeamScreen(appId: 'test_app_id'),
        ),
      );
