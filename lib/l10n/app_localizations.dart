...
abstract class AppLocalizations {
  ...
  /// Title for referral link header section
  ///
  /// In en, this message translates to:
  /// **'Your Referral Link'**
  String get shareRefLinkTitle;

  /// Description for referral link section
  ///
  /// In en, this message translates to:
  /// **'Share your referral link with friends, family, and contacts who might be interested in creating residual income with {business}.'**
  ...
  /// Title for partner card on share screen with business name
  ///
  /// In en, this message translates to:
  /// **'Current {business} Partners'**
  String sharePartnerCardTitle(String business);

  /// Title for partner referral link header section
  ///
  /// In en, this message translates to:
  /// **'Your Referral Link'**
  String get sharePartnerRefLinkTitle;

  /// Description for partner referral link section
  ///
  /// In en, this message translates to:
  /// **'Share your referral link with your {business} team members to give them the same AI recruiting tools you use.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'You know I\'m not a natural salesperson. Found Team Build Pro - it has pre-written messages and an AI Coach so you don\'t have to come up with sales pitches.\n\nYou can build a team BEFORE joining {business}. FREE until you qualify (3 direct + 12 total).\n\nI\'m testing it myself: {link}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I know you\'ve been burned before. Me too. Found Team Build Pro - not another opportunity, just a tool that lets you build a team BEFORE joining {business}.\n\nFREE until you qualify (3 direct + 12 total). See actual results before investing.\n\nI\'m exploring it myself: {link}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Awkward sales conversations make me cringe too. Found Team Build Pro - build a team online with pre-written messages. No cold calls, no face-to-face pitches.\n\nFREE until you qualify (3 direct + 12 total). Do this BEFORE joining {business}.\n\nI\'m trying it myself: {link}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Build in spare moments'**
  String get shareProspectTimeConstrainedSubject;

  /// No description provided for @shareProspectTimeConstrainedMessage.
  ///
  /// In en, this message translates to:
  /// **'I know you\'re as busy as I am. Found Team Build Pro - build a team in small chunks of time. AI Coach and pre-written messages make it efficient.\n\nFREE until you qualify (3 direct + 12 total). Do this BEFORE joining {business}.\n\nI\'m trying it during lunch breaks: {link}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Zero risk way to test {business}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I hate losing money on things that don\'t work out. Found Team Build Pro - it\'s FREE until you qualify (3 direct + 12 total).\n\nBuild a team BEFORE joining {business}. See if you can actually recruit people before spending anything.\n\nI\'m testing it myself: {link}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I\'m as skeptical as you are. Found Team Build Pro - not another opportunity, just a tool. Real metrics: who you\'ve contacted, who\'s interested, actual progress.\n\nFREE until you qualify (3 direct + 12 total). Data before joining {business}.\n\nI\'m testing it myself: {link}'**
