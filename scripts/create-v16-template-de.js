...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v16-template-de.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v16-de');
formData.append('comment', 'German - Professional focused (Mar 2026)');
