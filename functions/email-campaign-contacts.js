...
const CAMPAIGN_CONFIGS = {
  main: {
    name: 'CONTACTS EMAIL CAMPAIGN',
    logPrefix: '📧',
    batchIdPrefix: 'contacts_batch',
    sentField: 'sent',
    utmCampaign: 'direct_sales_contacts',
    campaignTag: 'contacts_campaign'
  }
};
...
async function sendEmailViaMailgun(contact, docId, config, index) {
  ...
  console.log(`   Template: ${templateVariant.toUpperCase()} | Subject: "${subject}"`);
