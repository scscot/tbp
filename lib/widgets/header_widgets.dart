...
class PrimaryAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Pull state from providers for the menu logic
  ...
  void _handleMenuSelection(String value, bool isProfileComplete, BuildContext context) async {
    ...
    switch (value) {
      ...
      case 'business':
        navigator.push(MaterialPageRoute(
            builder: (_) => BusinessScreen(appId: 'default')));
        break;
      case 'eligibility':
        navigator.push(MaterialPageRoute(
            builder: (_) => EligibilityScreen(appId: 'default')));
        break;
      case 'dashboard':
        navigator.push(MaterialPageRoute(
            builder: (_) => NavigationShell(appId: 'default')));
        break;
      case 'how_it_works':
        navigator.push(MaterialPageRoute(
      ...
      case 'messages':
        navigator.push(MaterialPageRoute(
            builder: (_) => MessageCenterScreen(appId: 'default')));
        break;
      case 'notifications':
        navigator.push(MaterialPageRoute(
      ...
      case 'platform_management':
        navigator.push(MaterialPageRoute(
            builder: (_) => PlatformManagementScreen(appId: 'default')));
        break;
      case 'privacy':
        navigator.push(MaterialPageRoute(
            builder: (_) => PrivacyPolicyScreen(appId: 'default')));
        break;
      case 'terms':
        navigator.push(MaterialPageRoute(
            builder: (_) => TermsOfServiceScreen(appId: 'default')));
        break;
    }
  }
