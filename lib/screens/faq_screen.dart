...
/// Audience types for FAQ filtering
enum FAQAudience {
  both,        // Show to all users
  prospect,    // Show only to prospects (userType == 'prospect')
  professional // Show only to professionals (userType == 'professional')
}
...
class _FAQScreenState extends State<FAQScreen> {
  ...
  Widget build(BuildContext context) {
    // Detect user type for audience filtering
    final user = Provider.of<UserModel?>(context, listen: false);
    _isProspect = user?.userType == 'prospect';
  ...
  List<FAQItem> _filterItems(List<FAQItem> items) {
    ...
    var filteredItems = items.where((item) {
      if (item.audience == FAQAudience.both) return true;
      if (_isProspect && item.audience == FAQAudience.prospect) return true;
      if (!_isProspect && item.audience == FAQAudience.professional) return true;
      return false;
    }).toList();
...
class FAQItem {
  ...
  const FAQItem({
    ...
    this.audience = FAQAudience.both,
  });
}
...
List<FAQItem> _gettingStartedFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    answer: context.l10n?.faqA3 ?? 'Absolutely! This is our core innovation. You can invite prospects and existing team members to Team Build Pro, let them experience team building success, and when they hit qualification milestones (3 direct sponsors + 12 total team members), they automatically get invited to join your business opportunity. It eliminates the "cold start" problem that kills most new distributors.',
    audience: FAQAudience.prospect, // Core prospect value proposition
  ),
  FAQItem(
    ...
    audience: FAQAudience.professional, // Professionals see trial info; prospects have free access
  ),
];
...
List<FAQItem> _businessModelFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    audience: FAQAudience.professional, // Already has a company
  ),
  FAQItem(
    ...
    audience: FAQAudience.prospect, // Not yet with a company
  ),
];
...
List<FAQItem> _howItWorksFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    audience: FAQAudience.professional, // Has a business opportunity to offer
  ),
  FAQItem(
    ...
    audience: FAQAudience.professional, // Team management feature
  ),
  FAQItem(
    ...
    audience: FAQAudience.both, // Both need this
  ),
];
...
List<FAQItem> _teamBuildingFAQs(BuildContext context) => [
  FAQItem(
    ...
    answer: context.l10n?.faqA12 ?? 'Direct sponsors are people you personally invite who join through your referral link. Total team members include your direct sponsors plus everyone they sponsor (your downline). For qualification, you need 3 direct sponsors and 12 total team members.',
    audience: FAQAudience.both,
  ),
  FAQItem(
...
List<FAQItem> _privacySecurityFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    audience: FAQAudience.professional, // Cancellation only applies to paid subscribers
  ),
  FAQItem(
...
List<FAQItem> _pricingFAQs(BuildContext context) => [
  FAQItem(
    ...
    audience: FAQAudience.professional, // Pricing question for paid users
  ),
  FAQItem(
    ...
    audience: FAQAudience.professional, // Business expense for professionals
  ),
  FAQItem(
    ...
    audience: FAQAudience.professional, // Cancellation for paid users
  ),
  FAQItem(
...
List<FAQItem> _concernsFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    audience: FAQAudience.professional, // Professionals recruiting prospects
  ),
  FAQItem(
    ...
    audience: FAQAudience.professional, // Has a current company
  ),
];
...
List<FAQItem> _successFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    answer: context.l10n?.faqA34 ?? 'This varies greatly by individual effort and market, but our most successful users achieve qualification (3 direct, 12 total) within a few weeks of consistent activity. Remember, you\'re building relationships, not just collecting sign-ups.',
    audience: FAQAudience.both,
  ),
  FAQItem(
...
List<FAQItem> _supportFAQs(BuildContext context) => [
  ...
  FAQItem(
    ...
    audience: FAQAudience.professional, // Has a sponsor/company
  ),
  FAQItem(
