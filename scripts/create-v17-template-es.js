#!/usr/bin/env node
/**
 * Create v17-es Mailgun template (Spanish)
 * v17 uses generic "Saludos!" greeting (no personalization)
...
const templateHtml = fs.readFileSync(path.join(__dirname, 'v17-template-es.html'), 'utf8');

const formData = new URLSearchParams();
formData.append('tag', 'v17-es');
formData.append('comment', 'Spanish - Generic greeting (Mar 2026)');
...
formData.append('headers', JSON.stringify({
  ...
  "Subject": "Tus prospectos no creen que pueden reclutar"
}));
