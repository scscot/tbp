...
// Set to Feb 21, 2026 for Preview Mode launch (visit/view tracking split)
const ANALYTICS_BENCHMARK_DATE = new Date('2026-02-21T00:00:00-08:00'); // PST
        ...
        try {
            ...
            leadsSnap.forEach(doc => {
                ...
                leadDetails.push({
                    ...
                    hasWebsite: !!(data.website && data.website.trim() !== ''),
