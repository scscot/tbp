...
const VARIANTS_ES = {
  v9a: {
    ...
    subject: 'No es una oportunidad. Solo una herramienta.',
    subjectTag: 'zinzino_v9a_es',
    description: 'V9-ES (no bullets) + Pattern interrupt'
  },
  v9b: {
    templateVersion: 'v9-es',
  ...
  v10a: {
    ...
    description: 'V10-ES (with bullets) + Pattern interrupt'
  },
  v10b: {
    templateVersion: 'v10-es',
    subject: 'La IA esta cambiando como crecen los equipos',
...
const VARIANTS_DE = {
  v9a: {
    ...
    subject: 'Keine Gelegenheit. Nur ein Werkzeug.',
    subjectTag: 'zinzino_v9a_de',
    description: 'V9-DE (no bullets) + Pattern interrupt'
  },
  v9b: {
    templateVersion: 'v9-de',
  ...
  v10a: {
    ...
    description: 'V10-DE (with bullets) + Pattern interrupt'
  },
  v10b: {
    templateVersion: 'v10-de',
    subject: 'KI verandert, wie Teams wachsen',
...
async function sendEmailViaMailgun(contact, docId, config, index) {
  ...
  // Tracking disabled - using Firestore-based tracking via trackEmailClick
